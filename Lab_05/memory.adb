...
S:Lmemory.main$p$1$27({1}SC:U),F,0,0
...
S:Fmemory$__str_0$0$0({5}DA5d,SC:S),D,0,0
S:Fmemory$__str_1$0$0({15}DA15d,SC:S),D,0,0
S:Fmemory$__str_2$0$0({53}DA53d,SC:S),D,0,0
S:Fmemory$__str_3$0$0({35}DA35d,SC:S),D,0,0
