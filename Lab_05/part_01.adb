...
F:G$On_Board$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$External$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$SYSCLK_INIT$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$PORT_INIT$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$UART0_INIT$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lpart_01.main$y$1$29({1}SC:U),R,0,0,[]
S:Lpart_01.main$num$1$29({1}SC:U),R,0,0,[r7]
S:Lpart_01.On_Board$i$1$32({2}SI:S),R,0,0,[]
S:Lpart_01.On_Board$ext_ram$1$32({2}DX,SC:U),E,0,0
S:Lpart_01.External$num$1$34({1}SC:S),E,0,0
S:Lpart_01.External$a$1$34({1}SC:S),E,0,0
S:Lpart_01.External$i$1$35({2}SI:S),R,0,0,[r5,r6]
S:Lpart_01.External$ext_ram$1$35({2}DX,SC:U),E,0,0
S:Fpart_01$count$0$0({1024}DA512d,SI:U),F,0,0
...
S:Fpart_01$__str_0$0$0({5}DA5d,SC:S),D,0,0
S:Fpart_01$__str_1$0$0({22}DA22d,SC:S),D,0,0
S:Fpart_01$__str_2$0$0({52}DA52d,SC:S),D,0,0
S:Fpart_01$__str_3$0$0({41}DA41d,SC:S),D,0,0
S:Fpart_01$__str_4$0$0({27}DA27d,SC:S),D,0,0
S:Fpart_01$__str_5$0$0({16}DA16d,SC:S),D,0,0
S:Fpart_01$__str_6$0$0({35}DA35d,SC:S),D,0,0
S:Fpart_01$__str_7$0$0({19}DA19d,SC:S),D,0,0
S:Fpart_01$__str_8$0$0({19}DA19d,SC:S),D,0,0
S:Fpart_01$__str_9$0$0({36}DA36d,SC:S),D,0,0
S:Fpart_01$__str_10$0$0({22}DA22d,SC:S),D,0,0
S:Fpart_01$__str_11$0$0({17}DA17d,SC:S),D,0,0
S:Fpart_01$__str_12$0$0({26}DA26d,SC:S),D,0,0
S:Fpart_01$__str_13$0$0({49}DA49d,SC:S),D,0,0
