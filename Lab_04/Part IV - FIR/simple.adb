...
F:G$MAC_Convert$0$0({2}DF,SI:S),Z,0,0,0,0,0
...
S:G$prev$0$0({2}SI:S),E,0,0
S:G$prev2$0$0({2}SI:S),E,0,0
S:G$prev_out$0$0({2}SI:S),E,0,0
S:Lsimple.main$wave$1$28({2}SI:S),R,0,0,[r4,r5]
S:Lsimple.main$x$1$28({2}SI:S),R,0,0,[r6,r7]
S:Lsimple.main$y$1$28({4}SF:S),E,0,0
...
S:Fsimple$__str_0$0$0({5}DA5d,SC:S),D,0,0
