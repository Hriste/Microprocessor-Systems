...
T:Fshiny$float_long[({0}S:S$f$0$0({4}SF:S),Z,0,0)({0}S:S$l$0$0({4}SL:S),Z,0,0)]
...
S:Lshiny.main$value$1$50({2}SI:S),R,0,0,[r6,r7]
S:Lshiny.score$value$1$54({2}SI:U),R,0,0,[]
S:Lshiny.score$volts$1$55({4}SF:S),E,0,0
S:Lshiny.score$hvolts$1$55({2}SI:S),E,0,0
S:Lshiny.score$sloc0$1$0({4}SF:S),E,0,0
...
S:Fshiny$__str_0$0$0({5}DA5d,SC:S),D,0,0
S:Fshiny$__str_1$0$0({36}DA36d,SC:S),D,0,0
S:Fshiny$__str_2$0$0({8}DA8d,SC:S),D,0,0
S:Fshiny$__str_3$0$0({10}DA10d,SC:S),D,0,0
S:Fshiny$__str_4$0$0({2}DA2d,SC:S),D,0,0
S:Fshiny$__str_5$0$0({3}DA3d,SC:S),D,0,0
S:Fshiny$__str_6$0$0({7}DA7d,SC:S),D,0,0
S:Fshiny$__str_7$0$0({6}DA6d,SC:S),D,0,0
S:Fshiny$__str_8$0$0({7}DA7d,SC:S),D,0,0
S:Fshiny$__str_9$0$0({7}DA7d,SC:S),D,0,0
S:Fshiny$__str_10$0$0({9}DA9d,SC:S),D,0,0
