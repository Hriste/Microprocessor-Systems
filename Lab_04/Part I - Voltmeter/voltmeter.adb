...
F:G$score$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
T:Fvoltmeter$float_long[({0}S:S$f$0$0({4}SF:S),Z,0,0)({0}S:S$l$0$0({4}SL:S),Z,0,0)]
S:G$running$0$0({4}SF:S),E,0,0
S:G$run$0$0({2}SI:S),E,0,0
S:G$min$0$0({4}SF:S),E,0,0
S:G$hmin$0$0({2}SI:S),E,0,0
S:G$max$0$0({4}SF:S),E,0,0
S:G$hmax$0$0({2}SI:S),E,0,0
S:G$trials$0$0({4}SF:S),E,0,0
S:Lvoltmeter.score$value$1$54({2}SI:U),R,0,0,[]
S:Lvoltmeter.score$volts$1$55({4}SF:S),E,0,0
S:Lvoltmeter.score$hvolts$1$55({2}SI:S),E,0,0
S:Lvoltmeter.score$sloc0$1$0({4}SF:S),E,0,0
...
S:Fvoltmeter$__str_0$0$0({5}DA5d,SC:S),D,0,0
S:Fvoltmeter$__str_1$0$0({36}DA36d,SC:S),D,0,0
S:Fvoltmeter$__str_2$0$0({8}DA8d,SC:S),D,0,0
S:Fvoltmeter$__str_3$0$0({10}DA10d,SC:S),D,0,0
S:Fvoltmeter$__str_4$0$0({2}DA2d,SC:S),D,0,0
S:Fvoltmeter$__str_5$0$0({3}DA3d,SC:S),D,0,0
S:Fvoltmeter$__str_6$0$0({7}DA7d,SC:S),D,0,0
S:Fvoltmeter$__str_7$0$0({6}DA6d,SC:S),D,0,0
S:Fvoltmeter$__str_8$0$0({7}DA7d,SC:S),D,0,0
S:Fvoltmeter$__str_9$0$0({7}DA7d,SC:S),D,0,0
S:Fvoltmeter$__str_10$0$0({9}DA9d,SC:S),D,0,0
