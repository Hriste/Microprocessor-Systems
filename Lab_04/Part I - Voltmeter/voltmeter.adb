...
S:G$trials$0$0({2}SI:S),E,0,0
S:Lvoltmeter.score$value$1$32({2}SI:U),R,0,0,[]
S:Lvoltmeter.score$volts$1$33({4}SF:S),E,0,0
...
S:Fvoltmeter$__str_1$0$0({16}DA16d,SC:S),D,0,0
S:Fvoltmeter$__str_2$0$0({34}DA34d,SC:S),D,0,0
S:Fvoltmeter$__str_3$0$0({38}DA38d,SC:S),D,0,0
S:Fvoltmeter$__str_4$0$0({38}DA38d,SC:S),D,0,0
S:Fvoltmeter$__str_5$0$0({38}DA38d,SC:S),D,0,0
