...
F:G$local$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$foreign$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$read$0$0({2}DF,SC:S),Z,0,0,0,0,0
F:G$dread$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$write$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$dummy$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Timer1_ISR$0$0({2}DF,SV:S),Z,0,0,1,1,0
...
F:G$SPI0_INIT$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:G$local_ct$0$0({2}SI:S),E,0,0
S:G$alien_ct$0$0({2}SI:S),E,0,0
S:G$counts$0$0({2}SI:S),E,0,0
S:LSPI0.main$c$1$33({1}SC:S),R,0,0,[r7]
S:LSPI0.main$i$1$33({2}SI:S),R,0,0,[]
S:LSPI0.main$d$1$33({1}SC:S),R,0,0,[r7]
S:LSPI0.local$c$1$37({1}SC:S),R,0,0,[r7]
S:LSPI0.foreign$c$1$41({1}SC:S),R,0,0,[r7]
S:LSPI0.dread$i$1$46({2}SI:S),R,0,0,[r5,r6]
S:LSPI0.dread$dumb$1$46({1}SC:S),R,0,0,[r7]
S:LSPI0.dummy$r$1$51({1}SC:U),R,0,0,[r7]
S:LSPI0.dummy$dumb$1$51({1}SC:S),R,0,0,[]
S:LSPI0.dummy$i$1$51({2}SI:S),R,0,0,[]
S:LSPI0.dummy$j$1$51({2}SI:S),E,0,0
...
S:FSPI0$__str_0$0$0({18}DA18d,SC:S),D,0,0
S:FSPI0$__str_1$0$0({5}DA5d,SC:S),D,0,0
S:FSPI0$__str_2$0$0({10}DA10d,SC:S),D,0,0
S:FSPI0$__str_3$0$0({8}DA8d,SC:S),D,0,0
S:FSPI0$__str_4$0$0({5}DA5d,SC:S),D,0,0
S:FSPI0$__str_5$0$0({7}DA7d,SC:S),D,0,0
S:FSPI0$__str_6$0$0({8}DA8d,SC:S),D,0,0
S:FSPI0$__str_7$0$0({4}DA4d,SC:S),D,0,0
S:FSPI0$__str_8$0$0({13}DA13d,SC:S),D,0,0
S:FSPI0$__str_9$0$0({21}DA21d,SC:S),D,0,0
S:FSPI0$__str_10$0$0({12}DA12d,SC:S),D,0,0
