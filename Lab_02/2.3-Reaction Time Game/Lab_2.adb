...
F:G$Flash$0$0({2}DF,SI:S),Z,0,0,0,0,0
...
S:G$tenth$0$0({4}SL:S),E,0,0
S:LLab_2.main$delay$1$43({2}SI:U),R,0,0,[]
S:LLab_2.main$turns$1$43({2}SI:U),R,0,0,[r6,r7]
S:LLab_2.main$slowness$1$43({2}SI:U),R,0,0,[r4,r5]
S:LLab_2.Flash$reaction$1$52({2}SI:S),R,0,0,[r6,r7]
S:G$SW2press$0$0({1}SB0$1:U),H,0,0
S:LLab_2.main$restart$1$43({1}SB0$1:U),R,0,0,[]
...
S:G$reaction$0$0({2}DF,SV:S),C,0,0
S:FLab_2$__str_0$0$0({5}DA5d,SC:S),D,0,0
S:FLab_2$__str_1$0$0({28}DA28d,SC:S),D,0,0
S:FLab_2$__str_2$0$0({34}DA34d,SC:S),D,0,0
S:FLab_2$__str_3$0$0({5}DA5d,SC:S),D,0,0
S:FLab_2$__str_4$0$0({7}DA7d,SC:S),D,0,0
S:FLab_2$__str_5$0$0({55}DA55d,SC:S),D,0,0
S:FLab_2$__str_6$0$0({9}DA9d,SC:S),D,0,0
S:FLab_2$__str_7$0$0({28}DA28d,SC:S),D,0,0
S:FLab_2$__str_8$0$0({26}DA26d,SC:S),D,0,0
S:FLab_2$__str_9$0$0({7}DA7d,SC:S),D,0,0
S:FLab_2$__str_10$0$0({40}DA40d,SC:S),D,0,0
S:FLab_2$__str_11$0$0({23}DA23d,SC:S),D,0,0
