...
S:Lold.getchar$c$1$10({1}SC:S),R,0,0,[]
S:G$Counts$0$0({2}SI:U),E,0,0
S:G$turns$0$0({1}SC:S),E,0,0
S:G$correct$0$0({1}SC:S),E,0,0
S:G$working$0$0({1}SC:U),E,0,0
S:Lold.main$temp$1$47({1}SC:U),E,0,0
...
S:G$random$0$0({2}DF,SC:U),C,0,0
S:G$putChar$0$0({2}DF,SV:S),C,0,0
S:G$main$0$0({2}DF,SV:S),C,0,0
S:Fold$__str_0$0$0({8}DA8d,SC:S),D,0,0
S:Fold$__str_1$0$0({10}DA10d,SC:S),D,0,0
